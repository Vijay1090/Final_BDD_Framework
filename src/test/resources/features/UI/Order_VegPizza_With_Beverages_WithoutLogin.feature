Feature: Verify end to end flow dominos Order Multiple Nonveg pizza without login
  ...
  @RegressionTest @SmokeTest @DominosOrdervegwithBeverage @DominosUITest1234
  Scenario: Verify end to end flow dominos Order Multiple Veg pizza with Beverages without login
    ...
    When Add multiple Veg pizzas with beverages also note there price consider "Veg_WithBeverage"
